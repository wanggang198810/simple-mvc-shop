...
class messageModelManager extends QModelManager
{
    ...
    {
        parent::__construct('messageModel');//之前我没有加上这句，父类并没有执行构造
    }
    ...
    //获取文章列表
    public function getMessageList($where = '',$sort="",$field="",$limit = null)
    {
        if($sort == null) $sort="addtime DESC";
        if($field == null) $field="id,title,content,addtime,isshow";
