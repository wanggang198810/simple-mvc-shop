<?php /* Smarty version 2.6.18, created on 2014-04-11 16:45:57
         compiled from foot.html */ ?>


<div class="wrap mt10 bgf none " id="login-reg-float">
    <span id="close-float"></span>
...
<div id="foot">
    <div class="wrap">
        <div class="menu">
            <a href="">网站首页</a>
            | <a href="danyemianyanshi/">服务须知</a>
            | <a href="wenzhangliebiaoyanshi/">广告合作</a>
            | <a href="kuozhanmoxingliebiaoyanshi/">关于我们</a>
            | <a href="kuozhanmoxingliebiaoyanshi/">联系我们</a>

        </div>
        <div id="copyright"> 版权所有：<a target="_blank" href="http://lyu-home.com">Lyu-Home</a> 地址：中国.临沂大学 信息学院 Mobile：+86-13013500185 &nbsp;
            QQ：1504336908
        </div>
    </div>
</div>