<?php /* Smarty version 2.6.18, created on 2014-04-11 17:26:03
         compiled from E:%5CPHPnow-1.5.6%5Chtdocs%5Cershou2014/views/fore/default/templates/article/list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'E:\\PHPnow-1.5.6\\htdocs\\ershou2014/views/fore/default/templates/article/list.html', 46, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <div class="wrap mt10">
            ...
            <div class="box bgf">
                <div id="pagenav">
                    当前位置:&nbsp; <a href="ss">首页</a> &gt; <a href="ss">网站新闻</a>
                </div>
            </div>
...
" title=" "><?php echo $this->_tpl_vars['articleList'][$this->_sections['sec1']['index']]['title']; ?>
                            ...
                            <span class="time"><?php echo ((is_array($_tmp=$this->_tpl_vars['articleList'][$this->_sections['sec1']['index']]['addtime'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%m-%d %H:%M") : smarty_modifier_date_format($_tmp, "%m-%d %H:%M")); ?>
</span>
                        </li>
