<?php /* Smarty version 2.6.18, created on 2014-04-12 08:03:37
         compiled from E:%5CPHPnow-1.5.6%5Chtdocs%5Cershou2014/views/admin/templates/info/index.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'E:\\PHPnow-1.5.6\\htdocs\\ershou2014/views/admin/templates/info/index.html', 92, false),)), $this); ?>
...
?>
            <tr>
                ...
                <td class="tdleft">
                    <a target="_blank" href="index.php?c=info&id=<?php echo $this->_tpl_vars['infoList'][$this->_sections['sec1']['index']]['id']; ?>
...
')" href="javascript:;" >[快速编辑]</a></span>
                ...
                <td>
                    <?php if (( $this->_tpl_vars['infoList'][$this->_sections['sec1']['index']]['isshow'] == 1 )): ?>
                    <span class="audit" onclick="audit('<?php echo $this->_tpl_vars['infoList'][$this->_sections['sec1']['index']]['id']; ?>
',<?php echo $this->_tpl_vars['infoList'][$this->_sections['sec1']['index']]['isshow']; ?>
,this)">已审</span>
                    <?php else: ?>
                    <span class="audit red" onclick="audit('<?php echo $this->_tpl_vars['infoList'][$this->_sections['sec1']['index']]['id']; ?>
',<?php echo $this->_tpl_vars['infoList'][$this->_sections['sec1']['index']]['isshow']; ?>
,this)">未审</span>
                    <?php endif; ?>
                </td>
                ...
                <td><?php echo $this->_tpl_vars['infoList'][$this->_sections['sec1']['index']]['hits']; ?>
</td>
                <td>
                    <a href="index.php?c=a_info&a=infoview&id=<?php echo $this->_tpl_vars['infoList'][$this->_sections['sec1']['index']]['id']; ?>
">修改</a>
