<?php /* Smarty version 2.6.18, created on 2014-04-11 17:06:35
         compiled from E:%5CPHPnow-1.5.6%5Chtdocs%5Cershou2014/views/fore/default/templates/member/published.html */ ?>
...
?>
                                                <tr>
                                                    ...
                                                    <td><span><a target="_blank" href="index.php?c=info&id=<?php echo $this->_tpl_vars['infoList'][$this->_sections['sec1']['index']]['id']; ?>
"><?php echo $this->_tpl_vars['infoList'][$this->_sections['sec1']['index']]['title']; ?>
                                                    ...
                                                    <td>6</td>
                                                    <td> <?php echo $this->_tpl_vars['infoList'][$this->_sections['sec1']['index']]['addtime']; ?>
 </td>

                                                    <td>
                                                        <?php if (( $this->_tpl_vars['infoList'][$this->_sections['sec1']['index']]['trait'] != '' )): ?>
                                                        <a class="green" href="javascript:void(0)" onclick="apply_trait('<?php echo $this->_tpl_vars['infoList'][$this->_sections['sec1']['index']]['id']; ?>
',this)">推荐申请中</a>
                                                        <?php else: ?>
                                                        <a  href="javascript:void(0)" onclick="apply_trait('<?php echo $this->_tpl_vars['infoList'][$this->_sections['sec1']['index']]['id']; ?>
',this)">申请推荐</a>
                                                        <?php endif; ?>
