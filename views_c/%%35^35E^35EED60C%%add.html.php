<?php /* Smarty version 2.6.18, created on 2014-04-11 23:02:01
         compiled from E:%5CPHPnow-1.5.6%5Chtdocs%5Cershou2014/views/admin/templates/article/add.html */ ?>
...
<div class="main">
    ...
    <div class="info">
            ...
            <div class="info">
                    <form action="?c=a_article&amp;a=add_save" method="post" id="gform">
...
"><?php echo $this->_tpl_vars['articleCategoryList'][$this->_sections['sec1']['index']]['fullname']; ?>
</option>
                                    <?php endfor; endif; ?>
                                </select>
                            </dd>
                        ...
                        <dl><dt>内容：</dt>
                            <dd>
                                ...
                                -->
                                <textarea class="int" style="width:550px; height:200px;visibility: hidden;" id='detail' name="detail">sss</textarea>
                            </dd>
                        </dl>
